...
flowchart TB
  ...
  L --> M["Limited email example rendered"]
  M --> N["Example email sent"]
  ...
  class A,B,C,D,D1,D2,F,I,O,Q,S,U,W,AJ,AK,AL done;
  class E,G,J,K,L,M,T,V,X,Y,AB,AD,AE,AF,AG partial;
  class H,N,P,R,Z,AA,AC,AH,AI,AM,AN todo;
```
